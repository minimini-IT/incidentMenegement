...
-->
        ...
        <div class="col-md-10">
            <h3 class="my-4"><?= __('リスク作成') ?></h3>
            <?= $this->Form->create($riskDetection) ?>
                <fieldset>
                    <div class="row">
                        <div class="col-md-1"></div>
                        <div class="col-md-2">
                    <?= $this->Form->control('response_start_time', ["label" => "対処開始時刻", "name" => "response_start_time[]", "type" => "text", "class" => "form-control datepicker", "value" => date("Y/m/d")]) ?>
                        </div>
                        <div class="col-md-1 d-flex align-items-end">
                    <?= $this->Form->control('response_start_time', ["label" => false, "name" => "response_start_time[]", "type" => "text", "class" =>"form-control", "placeholder" => "09:30", "value" => date("H:i")]) ?>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="row mt-4">
                        ...
                        <?= $this->Form->control('attachment', ["type" => "hidden", "value" => 0]) ?>
                        <?= $this->Form->control('incident_cases_id', ["type" => "hidden", "value" => 2]) ?>
                    <div class="row mt-4">
                        <div class="col-md-11">
