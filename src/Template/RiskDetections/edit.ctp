...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $riskDetection->risk_detections_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $riskDetection->risk_detections_id)]
            )
        ?></li>
...
<div class="riskDetections form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Risk Detection') ?></legend>
        <?php
